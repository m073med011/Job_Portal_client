...
export const AssignRecruiter = () => {
    ...
    const onSubmit = (data) => {
        ...
        console.log(newData);
        fetch("https://job-portal-7tgeem47h-mohameds-projects-59570ee8.vercel.app/recruiter/post-recruiter", {
            method: "POST",
        ...
        fetch(`https://job-portal-7tgeem47h-mohameds-projects-59570ee8.vercel.app/users/user/${data.recruiterID}`).then((res) => res.json()).then((data) => {
            let recruiterData = data
            setSelectedRecruiter(recruiterData);
            // console.log(data);
        })
        
        fetch(`https://job-portal-7tgeem47h-mohameds-projects-59570ee8.vercel.app/users/update-user/${data.recruiterID}`, {
            method: "PUT",
            headers: { 'content-type': 'application/json' },
            body: JSON.stringify({
