...
export const ShortlistedDetails = () => {
    ...
    useEffect(() => {
        ...
        console.log(job_id);
        try {
            fetch(`https://job-portal-7tgeem47h-mohameds-projects-59570ee8.vercel.app/users/user/${candidate_id}`)
            .then((res) => res.json())
            .then((data) => {
                setCandidate(data)
            })

            fetch(`https://job-portal-7tgeem47h-mohameds-projects-59570ee8.vercel.app/jobs/current-job/${job_id}`)
            .then((res) => res.json())
            .then((data) => {
                setJob(data)
            })
    ...
    useEffect(() => {
        try {
            fetch(`https://job-portal-7tgeem47h-mohameds-projects-59570ee8.vercel.app/application/all-application/`)
            .then((res) => res.json())
            .then((data) => {
