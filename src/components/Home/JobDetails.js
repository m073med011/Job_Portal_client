...
export const JobDetails = () => {
    ...
    useEffect(() => {
        fetch(`https://job-portal-7tgeem47h-mohameds-projects-59570ee8.vercel.app/jobs/current-job/${id}`).then(res => res.json()).then(
    ...
    const handleFileUpload = (e) => {
        ...
        fetch(`https://job-portal-7tgeem47h-mohameds-projects-59570ee8.vercel.app/upload/resume/${applicants._id}`, {
            method: "POST",
            body: formData,
        })
            .then((res) => res.json())
